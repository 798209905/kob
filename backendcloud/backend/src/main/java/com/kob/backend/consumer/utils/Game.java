...
public class Game extends Thread {
    ...
    private String loser = ""; //all:平局 A:A lose  B:B lose
    ...
    private String getInput(Player player){  //将当前局面信息编码为字符串
        Player me,you;
    ...
    private void sendBotCode(Player player){
        if(player.getBotId().equals(-1)) return; //人，亲自出马
    ...
    private void sendMove(){  //向前端返回两个client 的操作
        lock.lock();
        try{
