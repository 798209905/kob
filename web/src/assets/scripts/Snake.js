...
export class Snake extends AcGameObject {
    constructor(info, gamemap) {
        ...
        this.speed = 5; //蛇每秒钟走6格
        this.direction = -1; // -1没有指令，0/1/2/3表示上，右，下，左
        this.status = "idle";  //idle静止，move 表示移动，die表示死亡
    ...
    check_tail_increasing() {  //监测当前蛇的长度是否增加
